    			...
    			<div class="search-inner">
    				...
    				<form action="SearchServlet" method="post">
	    				<div class="input-group ">
	    						<input type="text" class="form-control searchBox" placeholder="搜索你想要的内容" name="search" id="search">
	    						<input type="submit" class="searchBtn"  id="search-btn" value="搜索"></input>
	    				</div>
	    			</form>
    			</div>
    		</div>
